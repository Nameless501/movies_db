    ...
    <div className="App">
      <Switch>
        ...
        <Route path={routesConfig.movie.topRated}>
          <TopRatedPage type="movie" title="Фильмы с высоким рейтингом" />
        </Route>
        <Route path={routesConfig.tv.topRated}>
          <TopRatedPage type="tv" title="Сериалы с высоким рейтингом" />
        </Route>

        {/* Popular pages */}

        <Route path={routesConfig.movie.popular}>
          <PopularPage type="movie" title="Популярные фильмы" />
        </Route>
        <Route path={routesConfig.tv.popular}>
          <PopularPage type="tv" title="Популярные сериалы" />
        </Route>
