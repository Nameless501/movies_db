...
function SlideMain({
  ...
  useIntersectionObserver(slideRef, ([{ isIntersecting }], observerElement) => {
    if (isIntersecting) {
  ...
  return (
    <div className="slide-main" ref={slideRef}>
      <PosterLazyLoad
      ...
      <div className="slide-main__content-wrapper">
        ...
        <p className="slide-main__description">{overview}</p>
        <CardButtons place="slide-main" id={id} type={type} />
        <ButtonMain
          as={Link}
