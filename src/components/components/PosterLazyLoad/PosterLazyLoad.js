...
import {
  POSTER_HORIZONTAL_ORIGINAL,
  POSTER_VERTICAL_SMALL,
  POSTER_HORIZONTAL_SMALL,
} from "../../../utils/constants";
import "./PosterLazyLoad.css";

function PosterLazyLoad({
  posterVertical,
  posterHorizontal,
  loadFullSize,
  place,
  ...
  const posterSmallSize = isMobile
    ? POSTER_VERTICAL_SMALL + posterVertical
    : POSTER_HORIZONTAL_SMALL + posterHorizontal;
