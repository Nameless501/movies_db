      ...
      <div className="footer__content-wrapper">
        <div className="footer__column">
          ...
          <p className="footer__attribution">
            Для проекта использовано API the movies DB. Проект не проходил
            сертификацию TMDB.
          </p>
          <p className="footer__copyright">&copy; 2023</p>
        </div>
        <div className="footer__column">
          <h4 className="footer__column-title">Карта сайта</h4>
          <NavigationBar place="footer" />
        </div>
        <div className="footer__column">
          <h4 className="footer__column-title">Ссылки</h4>
